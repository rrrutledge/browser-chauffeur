...
def spawn_worker(iid, json_file, repo, runtime_dir, worker_model, local_dir):
    ...
    with open(prompt_file, "w", encoding="utf-8") as f:
        f.write(
            ...
            "`launch-browser.py --close-owned`, which closes only this session's browser tabs (never the "
            ...
            "first close any browser tabs you opened with browser-chauffeur's `launch-browser.py "
