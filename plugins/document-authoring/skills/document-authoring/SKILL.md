...
- **Check-in framing when vetting a contact**: When asking someone to vet a potential outreach target, use "I'm wondering if X would be a good contact" rather than "I'm thinking of reaching out and wanted to check with you first." The latter sounds decided; the former stays open. Real edit: "I'm thinking of reaching out to him about the FINOS InnerSource WG and wanted to check with you first" → "I'm wondering if he would be a good contact for the FINOS InnerSource WG."

- **Widen the door on contact vetting**: When asking whether a named person would be a good outreach target, add "or someone he knows" — don't presume that person is the right one; leave room for redirection. Real edit: added "or someone he knows" to "I'm wondering if he would be a good contact for the FINOS InnerSource WG."

- **LinkedIn/profile URLs go inline at the end of the relevant sentence**, not on their own line. And skip the "Russ" sign-off in a very short casual DM to a close colleague — the message is already personal enough. Real edits: a LinkedIn profile URL moved from its own paragraph to inline at the end of the sentence; "Russ" sign-off dropped from a short DM.
