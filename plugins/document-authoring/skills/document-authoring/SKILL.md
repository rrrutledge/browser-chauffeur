...
- **Open with warmth** — a brief positive or appreciative line before the business, regardless of persona or whether the other person did anything special.
  ...
  **Exception - a pure celebratory reaction to someone's spontaneous good news, with no follow-on business or ask:** react to the news itself with a short, genuine exclamation ("Oh my goodness [Name] this is so wonderful!") rather than analytically crediting the specific effort behind it. The action-crediting form is for a message that itself reports the effort (hours spent, a list of what got done) - there, that reported effort is the thing to react to; a brief spontaneous share has nothing to credit beyond the news, so the plain exclamation is what's genuine.
