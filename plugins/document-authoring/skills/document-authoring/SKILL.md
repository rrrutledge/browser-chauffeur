...
- **Keep asks open and tentative — don't pre-commit.** Write as though the outcome is still open; give the reader lots of room to say no or redirect. Hedge with "may" and "wondering", include alternatives ("or someone he knows"), and avoid framing that pins the person to a specific action. Real edits: "I'm planning to…" → "I'm wondering if…"; "I'm thinking of reaching out and wanted to check with you first" (announces a decided course) → "I'm wondering if I should reach out and wanted to check with you first" (invites the reader to weigh in).
...
- **When a practical question is genuinely implied, ask it — don't substitute enthusiasm.** If the situation leaves an obvious unresolved logistical question (not something the reader already knows), ask it directly instead of closing with a warm but vague line. Real edit: a thank-you to Yoshi for sending a Japanese email to Panasonic contacts closed with "Very excited to see where this goes." — Russ replaced it with a casual observation and a concrete question about the language chain going forward: "Everything is translated these days. Should I respond in English and let Nakao-san translate on his side? Or should I AI-translate on my end?" The situation genuinely had an open question; enthusiasm alone wasn't enough.
- **No "helper tail."** When you've said the thing, stop. Don't append an extra offer, hint at a next step, or tack on a closing ask when the message already implies it. Ask: does this sentence add information the reader doesn't already have, or does it just restate what's obvious from what came before? If the latter, cut it. Russell says what he wants to say and ends — often right after a question mark. Real edits: he cut "If you hit that error again, grab a screenshot and I'll jump right back in. Thanks for flagging it!" to "Let me know how it goes?"; replying to someone who'd just deleted+recreated a repo, he cut "Just push your code back into it whenever you get a chance. Really appreciate it!" to "Looks good!  You should have correct access to the new repo."; thanking someone who completed a requested task, he cut "Thanks, Krishna!  Glad to have that sorted." to "Thanks, Krishna!" — the closing comment was surplus; when someone couldn't make an intro he'd asked for, a 4-sentence draft ("Thanks for checking, Nathen! I appreciate you getting back to me. I'll reach out to Navin directly. Hope you're doing well!") was sent as "OK - sounds good 👍.  Nice to hear from you" — the action narration ("I'll reach out directly") and the warm-close sentiment both cut, because stating your obvious next step and re-asserting warmth at the end of an already-warm message add nothing.
