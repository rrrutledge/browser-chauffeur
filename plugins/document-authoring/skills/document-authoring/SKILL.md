...
- **A peer relationship, established or just forming** → warmth is in-voice even at work: a short forward-looking note ("This'll be great") alongside the acknowledgment (execute per **Energizing close**). This covers someone you lead, a peer you're genuinely warm with — inside or outside your org, a fellow nonprofit executive director as much as a colleague — someone who outranks you whenever the rapport itself is warm, and a contact where forming the relationship is the point, like a recruiter or interviewer on the other side of a role Russell is pursuing, even on their very first exchange. Rank alone never overrides warmth in either direction, and neither does tenure: how long you've known someone matters less than whether this is a relationship worth investing energy in.
...
- **React to the specific thing they shared, and warm a rote close into genuine interest.**
  ...
  When the detail they shared is a contribution they're already making - bringing others into the community, promoting the work - close by thanking them for that contribution rather than inviting them to do it, since the invitation implies they haven't started.
