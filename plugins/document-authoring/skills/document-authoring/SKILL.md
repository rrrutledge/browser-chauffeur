...
- **React to the specific thing they shared, and warm a rote close into genuine interest.**
  ...
  When a contact shares a job-search resource or lead (a job board, a channel, a tip) rather than an offer to connect people, thank them briefly and keep the relationship open by naming the concrete future ask this earns — "if I see someone or something interesting where you're connected, I'll reach out for your take or an introduction" — rather than a bare acknowledgment. This is the one case where naming a future ask isn't a helper-offer tail to cut: it's the reciprocal step that keeps a network contact active.
