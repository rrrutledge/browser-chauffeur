...
- **Replying to a message that's been sitting: acknowledge the delay.** When the inbound mail is weeks or months old, add a brief, plain "Sorry for the delay in responding" near the sign-off — don't let a late reply go out as if it were timely. Real edit (a ~3-month-old forward from a peer): a close of "Thanks again for keeping the elections running. / Russ" was sent as "Sorry for the delay in responding / Thanks for all of your help with the elections / Russ" — a delay apology added, and the narrow "keeping the elections running" broadened to the warmer "all of your help with the elections."
- *Samples:*
