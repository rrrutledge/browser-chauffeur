...
- **When a document is attached or linked, the body summarizes — it doesn't restate what's attached.**
  ...
  **When the attachment itself is the answer, drop the summary too** — say what it is, point at it, and carry in the body only what the attachment leaves out (e.g. the international SWIFT/BIC a domestic bank letter omits), never the facts it already states.
