...
- **Don't echo back a commitment they made — use an open affirmation instead.** When someone states a specific deadline or promise ("I'll have it done by Friday"), affirming "end of week sounds great" implicitly holds them to it and adds subtle pressure. Replace with an open-ended affirmation that removes the constraint. Real edit: "End of week sounds great, Kern." → "It was whatever works for you."
...
- **Cold-email sponsorship opener: gauge interest first, don't lead with "sponsor," ask one combined interest-plus-contact question.** When emailing a generic/cold inbox (not a named person), don't pitch the commitment up front — soften the offer and pair "is this of interest?" with "who could I work with?" in a single sentence, rather than offering a menu of next steps. Drop "Thanks!" and a doubled first name from the sign-off. Real edits, all in one send: "I'd love to have Infineon involved **as a sponsor**" → "I'd love to have Infineon involved"; "I **think** your team would feel right at home" → "I **hope** your team would feel right at home"; and the two-part "who's the right person… *and* I'm happy to send the sponsorship details or grab 20 minutes" menu was replaced with one question — "Is this event of interest to you and is there a person on your side that I could work with to help with Infineon's involvement?"
- *Samples:*
