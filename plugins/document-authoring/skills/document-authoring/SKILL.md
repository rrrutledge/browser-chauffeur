...
- **When asking someone to do something, just ask — don't tell them how to do it.** State what you need and stop; don't follow the ask with instructions, a suggested approach, or an offer to explain the method. That's their domain. Real edit (asking Yuki to intro Russell to Tomohiro Nakajima at KDDI): a draft that asked then appended "If so, here's a short blurb you can use: [blurb]  Happy to adjust anything if you'd like to word it differently." was sent as just the question alone.
