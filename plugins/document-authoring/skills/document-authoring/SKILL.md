...
- **Introducing several named people via @mention (a welcome roster, new hires): lead each bullet with the mention itself, skip the bold lead-in, and skip inline links** - let the credit read as one plain flowing sentence naming what they did, since the mention already anchors the bullet the way a bold phrase would elsewhere.
