...
- **Soften a commercial ask, especially through a bridge contact.** When reaching out about sponsorship or money via a warm intermediary, frame it as inviting *participation* / gauging interest rather than naming the commercial transaction, and keep the ask open-ended instead of a directed request for a specific named introduction. Real edit (asking a past speaker for an intro to his former employer): a draft "we're lining up **sponsors** for InnerSource Summit 2026 … would you make a warm introduction to [named person], or point me to whoever would be best?" was sent as "we're lining up **participants** for InnerSource Summit 2026 and we're wondering if there is still a way to connect with your former organization … Do you still know anyone there that would be interested?"
