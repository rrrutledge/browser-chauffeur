...
- **A clause split out of a run-on, or a sign-off line that echoes something the correspondent already said, still counts as restatement.**
  ...
  A reaction to content someone shared is the same move again - "is a good story" carries it alone; drop a clause tying it back to a purpose the thread already established ("the kind of concrete example I wanted for the talk").
