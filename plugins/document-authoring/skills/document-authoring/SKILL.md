...
- **When an FYI arrives without a clear ask, ask about the content — not about the sender's intent.** Skip the meta-question ("is there something specific you need, or were you just sharing FYI?") and ask the specific thing you're actually curious about. Real edit (Greg forwarded a screenshot from Adam in the Tech Managers Round Table Channel, flagged by Shirley — no ask stated): a draft that asked "Is there something specific you need from me on this, or were you just sharing FYI?" was sent as "What was the context where Shirley pointed it out?" — the meta-question dropped in favor of what Russell actually wanted to know.
