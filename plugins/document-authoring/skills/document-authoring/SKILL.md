...
- **Apologize genuinely and briefly** — "Sorry this is taking so long.", "I'm sorry I have to move this again."
  On a follow-up that confirms a fix after you dropped the ball (missed a call, forgot to reply), restate the apology in a short clause even though you already apologized upthread — "thanks for understanding" alone reads as glossing over it.
