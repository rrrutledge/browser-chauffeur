...
- **Flag an ask buried after dense content with a light lead-in** — Russell's go-to is "One small ask -". But when the message is short and the thread already carries the context, cut both the context and the lead-in and let the bare question stand.
  **The same light lead-in flags an ask buried after a personal exchange at the open of the message** - a question put back to them, a couple of sentences trading news - not just dense informational content: mark the turn with an explicit line ("I was wondering about a bit of help for me") rather than jumping straight from the personal exchange into the ask.
...
- **Email subject**: a short noun phrase, no trailing `?` even when the email asks a question.
  **To a personal friend, keep it generic rather than naming the specific target** - "Quick ask", not "Quick ask - JLL".
