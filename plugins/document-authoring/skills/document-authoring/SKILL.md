...
- **Stay exploratory — don't pre-commit to an action.** Write as though the outcome is still open, not as though you've already decided and are just informing the reader. Use "I'm wondering if…" rather than "I'm planning to…" or "I'm thinking of reaching out and wanted to check with you first." The latter announces a decided course; the former invites the reader to weigh in.

- **Make asks wide and soft.** Give the reader lots of room to say no or redirect. Include alternatives ("or someone he knows"), hedge with "may" and "wondering", and avoid framing that pins the person to a specific action. The ask lands as an open question, not a directive.
