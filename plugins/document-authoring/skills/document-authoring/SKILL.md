...
- **Prefer "good" over "great" as a descriptor, and dial back superlative claims in cold outreach.** Russell consistently dials back superlatives — "good initial response" not "great initial response", "good turnout" not "great turnout". Reserve "great" for short standalone exclamations ("Great!") or genuine singular praise, not as an amplifier on nouns. In cold outreach body copy, also avoid "one of the largest/most X of any company" framing even when accurate — use the plain "a large X" instead. Real edit (HCL OSPO email): "one of the largest contingents of any company in our community Slack" → "a large contingent of people in our community Slack".
...
- **When a contact has flagged a caveat, release the pressure plainly — don't echo the caveat back.** If they said "budget climate is tough," skip any acknowledgment of that framing and just say "Either way is fine" and stop. Reflecting their stated constraint back reads as slightly patronizing; plain release is cleaner.
...
- **When someone shares career/personal bad news, acknowledge briefly and ask how they're doing — don't narrate the loss.** Keep the acknowledgment short ("sorry to hear it"), cut any editorial about the broader impact ("that's a real loss for the community"), and follow with a genuine personal question ("How are things going for you now?"). Real edit: "sorry to hear about the Wipro team.  That's a real loss for the community." + "would love to have you!" → "sorry to hear it." + "How are things going for you now?" — the impact sentence and the effusive close both dropped, the human check-in added.
...
- **Email subject line**: use a short noun phrase — no trailing `?` for 1on1 emails even when asking a question. Real edit: draft subject "Atlassian intro?" was sent as "Atlassian intro". Exception: cold outreach emails whose subject is itself an invitation can use question framing — "Participate in InnerSource Summit 2026?" is in-voice as a cold outreach subject.
...
- **React to the specific thing they shared, and warm a rote close into genuine interest.** When the other person mentioned a concrete detail (where they're job-hunting, what they're working on), respond to *that* rather than a generic well-wish — and swap the reflexive "let me know how it goes" for warmer forward-looking interest when you actually care how it turns out. Real edits (a LinkedIn reply to a friend job-searching across AZ/TX/NV): a flat "Good luck with the search - let me know how it goes. 👍" was sent as "Good luck with the search.  I haven't heard of tech in Nevada, but Arizona and Texas for sure.  I'll be excited to hear how it goes. 👍" — a real reaction to the named states added, and "let me know how it goes" warmed to "I'll be excited to hear how it goes." In the same reply, "would love to have you closer" was toned down to the less presumptuous "we'll have to see how close you end up."
...
- **Don't pitch why someone is a good fit when asking them to participate.** When inviting a warm contact to join something (a working group, a program, a community), don't follow the invitation with a list of reasons they're a great fit ("X's experience - A, B, C - is exactly what we need"). Trust the context; the ask stands on its own. Real edit (FINOS WG invite to a contact who'd spent months contributing InnerSource patterns): "Thales's experience - the career paths, Steering Board model, I/O Days, and licensing framework - is exactly what they're looking for.  Would you or someone at Thales be interested in participating?  Let me know!" → "Would you or someone at Thales be interested in participating?"
...
3. For each voice change, fold it into the matching section — **Formal writing** if the message was formal, **Conversational writing** if it was a chat/email reply. **Default to sharpening an existing bullet** — scan for one whose subject overlaps and tighten its rule text or swap in a better example. Add a new example only when the rule genuinely can't be understood without one; add a new bullet only when no existing subject overlaps at all. State it positively. Don't accumulate near-duplicates.
