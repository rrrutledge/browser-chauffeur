...
- **Forwarding a note originally written to someone else: trim its closing lines that were addressed specifically to that original recipient** - a commitment made to them, or an invitation aimed at their involvement - and keep only the substance the new recipient actually needs.
