...
- **On unanswered outreach with no attachment, how to execute depends on Register's arms-length/peer axis.** An arms-length contact gets a plain open prod with a "let me know" close — "wanted to ask again about this. Let me know what you think." A peer contact gets the release stated before the ask instead of after, with receipt-confirm framing — "either way things go is fine, but wanted to make sure you'd seen this?"
