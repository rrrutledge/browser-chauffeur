...
- **No "helper tail" — but do ask when there's a genuine open question.** When you've said the thing, stop. Don't append an offer, hint at a next step, or restate what's already obvious. The test: does this sentence give the reader something they don't already have? If not, cut it. The exception: when the situation leaves a real unresolved logistical question, ask it directly instead of closing with vague enthusiasm — "Very excited to see where this goes" is a tail; "Should I respond in English and let Nakao-san translate, or should I AI-translate on my end?" is a real question that belongs. Russell says what he wants to say and ends — often right after a question mark. **When Russell personally owns the next step, say "I'll" — not "we'll" — and drop the trailing offer.** Real edit (a CFP-committee update): "We'll have the committee locked and themes outlined well before July 8 - you'll hear from us as soon as we do. Let me know if you need anything on your end in the meantime!" → "I'll try to finish this week. Thanks for pushing to do it ✅." — personal ownership named directly, helper tail cut.
...
- Closes with **"let me know"** — a signature phrase used constantly: "Take a look and let me know.", "Let me know what you think.", "Let me know if this time works for you.", "Let me know if I've got that right." Reach for "let me know" rather than near-variants. Real edit: he changed a draft's "just say the word" to "just let me know". **Exception — when joining a group conversation where the recipients decide among themselves:** if Russ is chiming in on a thread where the next step belongs to others talking it over internally, end by widening the options rather than landing a direct ask. Real edit (reply-all to ING colleagues that Gijs had looped in): draft ended "Let me know if anyone would be interested in attending or contributing" → sent as "Any InnerSource work at ING that the broader community would love to hear about, too. Or you can advertise for folks to attend and learn from others." — options offered, no direct ask placed on the recipients.
