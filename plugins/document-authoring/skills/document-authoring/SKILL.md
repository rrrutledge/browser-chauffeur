...
- **Defending a price you already quoted, under cost pushback: hold the number and ground it in concrete datapoints from your own world - don't volunteer a discount or a smaller scope.**
  Back the figure with specifics (a parallel engagement paying the same rate, a domain friend's read that it's fair or even a bit low) rather than an abstract "it's market rate" or a breakdown of the hours, and affirm the other side's right to weigh it themselves ("everyone makes their own value call, and that's fine").
  This is the mirror of the money-*ask* above: quoting a price offers a low-commitment floor; defending a quote offers none.
