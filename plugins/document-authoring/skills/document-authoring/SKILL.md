...
- **Describe the ask in plain, outward-facing language, not the internal tool or tracking term for it** — "inviting featured speakers" rather than "the keynote candidate list", even when writing to the very team that maintains that list. The reader wants the plain ask, not the name of the artifact behind it.
