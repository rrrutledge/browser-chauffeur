...
**Writing through a channel subject to third-party review (prison mail, a shared or monitored inbox): refer to another person by relationship, not by name.** Swap a real name for how they're connected to Russell ("a Sister in the ward," "a friend from work") so someone else's name and situation aren't entered into a record neither of you controls.
...
- **When someone shares a pending outcome they track closely themselves (a legal case, a health result, a decision on its way) with their own timeline attached: answer with general hope, not their specifics restated as a confident prediction.** They already know their own numbers better than you do - "I hope that works out soon" carries the same warmth as naming their exact date back to them, without risking a guess that lands wrong.
