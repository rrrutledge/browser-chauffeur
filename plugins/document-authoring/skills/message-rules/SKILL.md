...
- **Energizing close** — how to execute a warm close, when **Register** calls for one: end with a brief forward-looking note ("Looking forward to it!", "This'll be great") instead of a helper-offer tail.
  ...
  **When a peer's favor demonstrably paid off** (an introduction connected, a lead came through), swap the forward-looking note for a reciprocal offer to help them in turn - "let me know if I can do anything for you" mirrors the warmth they just showed, where a note about your own outcome would center yourself instead.
...
- **React to the specific thing they shared, and warm a rote close into genuine interest.**
  ...
  When they share a job-search resource or lead instead of an offer to connect people, thank them briefly and name the concrete future ask it earns ("if I see something where you're connected, I'll reach out for your take or an introduction") - the reciprocal case where naming a future ask of your own belongs, distinct from offering to help them back once their own favor has paid off (see **Energizing close** above).
