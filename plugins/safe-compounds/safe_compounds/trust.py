...
TRUSTED_COMMANDS = {
    'awk',
    'base32', 'base64', 'basename', 'bash', 'bc', 'bq',
    'cal', 'cat', 'cd', 'claude', 'clip', 'cmp', 'code', 'column', 'comm', 'command', 'credential', 'cut', 'cygpath',
    ...
    'gcloud', 'getconf', 'gh', 'git', 'grep', 'groups', 'grype',
    ...
    'od', 'openssl',
    'Program', 'pandoc', 'paste', 'pg_isready', 'pip', 'pnpm', 'printenv', 'ps', 'psql', 'pwd', 'pythonw',
    'Read', 'readlink', 'realpath', 'rev', 'rm', 'rmdir',
    'seq', 'sha1sum', 'sha256sum', 'sha512sum', 'sleep', 'snyk', 'sort', 'source', 'stat', 'strings', 'systeminfo',
    'tac', 'tail', 'tasklist', 'tee', 'test', 'time', 'timeout', 'touch', 'tr', 'tree', 'trivy', 'tty', 'type',
    'uname', 'unexpand', 'uniq', 'unset', 'unzip', 'uptime', 'users',
