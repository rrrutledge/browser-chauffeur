// Installs the gmail script dependencies (imapflow, mailparser, nodemailer) into a stable per-user
// location so every gmail script can resolve them, regardless of which directory it runs from.
